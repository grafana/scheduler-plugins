...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*LooseBinPackArgs)(nil), (*config.LooseBinPackArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_LooseBinPackArgs_To_config_LooseBinPackArgs(a.(*LooseBinPackArgs), b.(*config.LooseBinPackArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LooseBinPackArgs)(nil), (*LooseBinPackArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LooseBinPackArgs_To_v1_LooseBinPackArgs(a.(*config.LooseBinPackArgs), b.(*LooseBinPackArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_LooseBinPackArgs_To_config_LooseBinPackArgs(in *LooseBinPackArgs, out *config.LooseBinPackArgs, s conversion.Scope) error {
	out.CpuThresholdPercent = in.CpuThresholdPercent
	out.MemoryThresholdPercent = in.MemoryThresholdPercent
	return nil
}

// Convert_v1_LooseBinPackArgs_To_config_LooseBinPackArgs is an autogenerated conversion function.
func Convert_v1_LooseBinPackArgs_To_config_LooseBinPackArgs(in *LooseBinPackArgs, out *config.LooseBinPackArgs, s conversion.Scope) error {
	return autoConvert_v1_LooseBinPackArgs_To_config_LooseBinPackArgs(in, out, s)
}

func autoConvert_config_LooseBinPackArgs_To_v1_LooseBinPackArgs(in *config.LooseBinPackArgs, out *LooseBinPackArgs, s conversion.Scope) error {
	out.CpuThresholdPercent = in.CpuThresholdPercent
	out.MemoryThresholdPercent = in.MemoryThresholdPercent
	return nil
}

// Convert_config_LooseBinPackArgs_To_v1_LooseBinPackArgs is an autogenerated conversion function.
func Convert_config_LooseBinPackArgs_To_v1_LooseBinPackArgs(in *config.LooseBinPackArgs, out *LooseBinPackArgs, s conversion.Scope) error {
	return autoConvert_config_LooseBinPackArgs_To_v1_LooseBinPackArgs(in, out, s)
}
