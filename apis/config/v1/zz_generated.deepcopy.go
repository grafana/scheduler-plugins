...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LooseBinPackArgs) DeepCopyInto(out *LooseBinPackArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LooseBinPackArgs.
func (in *LooseBinPackArgs) DeepCopy() *LooseBinPackArgs {
	if in == nil {
		return nil
	}
	out := new(LooseBinPackArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LooseBinPackArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
